namespace Amazon.Elb.Tests
{
    public class CreateRuleResponseTests
    {
        ...
        public void Deserialize()
        {
            ...
            string text = @"<CreateRuleResponse xmlns=""http://elasticloadbalancing.amazonaws.com/doc/2015-12-01/"">
  <CreateRuleResult> 
    <Rules> 
      <member> 
  ...
  <ResponseMetadata> 
    <RequestId>c5478c83-f397-11e5-bb98-57195a6eb84a</RequestId> 
            ...
            var r = ElbSerializer<CreateRuleResponse>.DeserializeXml(text);

            Assert.Single(r.CreateRuleResult.Rules);

            var rule = r.CreateRuleResult.Rules[0];
