namespace Amazon.Elb.Tests
{
    public class ModifyTargetGroupResponseTests
    {
        ...
        {
            // Test data via https://docs.aws.amazon.com/elasticloadbalancing/latest/APIReference/API_ModifyTargetGroup.html

            string text = @"<ModifyTargetGroupResponse xmlns=""http://elasticloadbalancing.amazonaws.com/doc/2015-12-01/"">
  ...
  <ResponseMetadata> 
    <RequestId>8525b334-f466-11e5-aa04-33bf366f62e2</RequestId> 
            ...
            var r = ElbSerializer<ModifyTargetGroupResponse>.DeserializeXml(text);

            var tg_0 = r.ModifyTargetGroupResult.TargetGroups[0];
