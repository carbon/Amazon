namespace Amazon.Route53.Tests
{
    public class ListResourceRecordSetResponseTests
    {
        ...
        {
            string text = @"<ListResourceRecordSetsResponse xmlns=""https://route53.amazonaws.com/doc/2013-04-01/"">
   <ResourceRecordSets>
      <ResourceRecordSet>
   ...
   <NextRecordType>NS</NextRecordType>
            ...
            var result = Route53Serializer<ListResourceRecordSetsResponse>.DeserializeXml(text);
